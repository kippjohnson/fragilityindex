...
The new model fit to the perturbed data is `nonsigmodel` while the new null model is `nonsignullmodel`. `Var` is no longer statistically significant while `Covar` is, since points which favor `Var`'s significance have been removed.
